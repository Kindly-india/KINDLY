    ...
    <section className="bg-gradient-to-b from-[#fffbeb] to-[#fef3c7] py-16 md:py-24 overflow-hidden">
      <div className="max-w-5xl mx-auto px-6 md:px-6">
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-xl bg-white rounded-2xl p-8 md:p-12 shadow-md shadow-[#d97706]/5 hover:shadow-xl hover:shadow-[#d97706]/10 transition-all duration-300 flex flex-col">
