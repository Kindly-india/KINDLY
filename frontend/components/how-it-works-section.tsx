        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-12">
          ...
          <div className="relative">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-white shadow-xl shadow-[#059669]/10 flex items-center justify-center mb-4 md:mb-6 relative">
              ...
              <h3 className="text-[18px] md:text-[24px] font-semibold text-[#1d1d1f] mb-2 md:mb-3">Create Profile</h3>
              <p className="text-[14px] md:text-[17px] text-[#86868b] leading-relaxed max-w-[200px] md:max-w-none">
          ...
          <div className="relative">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-[18px] md:text-[24px] font-semibold text-[#1d1d1f] mb-2 md:mb-3">Find Events</h3>
              <p className="text-[14px] md:text-[17px] text-[#86868b] leading-relaxed max-w-[200px] md:max-w-none">
          ...
          <div className="relative">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-[18px] md:text-[24px] font-semibold text-[#1d1d1f] mb-2 md:mb-3">Make Impact</h3>
              <p className="text-[14px] md:text-[17px] text-[#86868b] leading-relaxed max-w-[200px] md:max-w-none">
