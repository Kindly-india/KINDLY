    ...
    <div className="bg-white min-h-screen pb-24">
      ...
      <section className="pt-16 px-6">
        <div className="max-w-3xl mx-auto prose prose-lg prose-gray text-gray-600">
          <h2 className="text-2xl font-bold text-[#1d1d1f] mb-4">1. Introduction</h2>
          <p className="mb-8">
          ...
          <h2 className="text-2xl font-bold text-[#1d1d1f] mb-4">2. Information We Collect</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1d1d1f] mb-4">3. How We Use Your Information</h2>
          <ul className="mb-8 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-[#1d1d1f] mb-4">4. Sharing Your Information</h2>
          <p className="mb-4">
          ...
          <p className="mb-8 font-medium text-[#1d1d1f]">
            We will never sell your personal data to third-party advertisers.
          </p>

          <h2 className="text-2xl font-bold text-[#1d1d1f] mb-4">5. Data Security & Your Rights</h2>
          <p>
