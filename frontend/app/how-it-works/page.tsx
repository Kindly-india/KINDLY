...
export default function HowItWorksPage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Hero */}
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-[#f5f5f7] to-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <span className="inline-block text-xs font-bold uppercase tracking-widest text-[#86868b] mb-5">How It Works</span>
          <h1 className="text-5xl md:text-7xl font-bold text-[#1d1d1f] tracking-tight mb-6 leading-[1.05]">
            ...
            {(activeTab === "volunteers" ? volunteerSteps : orgSteps).map((step) => (
              <div key={step.id} className={`flex gap-6 p-6 md:p-8 rounded-2xl border ${(step as any).border || "border-gray-100"} bg-white shadow-sm hover:shadow-md transition-shadow`}>
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-gray-500 leading-relaxed text-[15px]">{step.detail}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 px-6 bg-[#f5f5f7]">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-[#1d1d1f] mb-12 text-center">Frequently Asked Questions</h2>
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-4xl font-bold text-[#1d1d1f] mb-4">Ready to get started?</h2>
          <p className="text-gray-500 mb-8 text-lg">Join thousands of volunteers across India making a difference every week.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/org-signup"
              className="h-12 px-8 bg-white border-2 border-[#1d1d1f] hover:bg-[#f5f5f7] text-[#1d1d1f] text-[15px] font-bold rounded-full inline-flex items-center justify-center transition-colors"
            >
