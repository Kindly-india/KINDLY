  ...
  return (
    <div className="bg-white min-h-screen">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-5 mb-4">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400 uppercase tracking-wide">Registered Volunteers</div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between mt-2">
                    <span className="text-xs text-gray-400">78 checked in</span>
                ...
                <div className="bg-white rounded-2xl shadow-sm p-5 mb-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400 uppercase tracking-wide">Avg Turnout Rate</div>
                    </div>
                  </div>
                </div>
                <div className="bg-white rounded-2xl shadow-sm p-5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400 uppercase tracking-wide">Certificates Issued</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 px-6 bg-[#f5f5f7]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#1d1d1f] mb-4">How it works for you</h2>
            <p className="text-gray-500 text-lg max-w-xl mx-auto">From registration to certificates — the full organisation workflow.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            {steps.map((step, i) => (
              <div key={i} className="text-center">
                <div className="w-12 h-12 rounded-full bg-[#1d1d1f] text-white flex items-center justify-center text-sm font-bold mx-auto mb-4">
                  {step.n}
                </div>
                <h3 className="font-bold text-[#1d1d1f] text-sm mb-2">{step.title}</h3>
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#1d1d1f] mb-4">Every tool you need</h2>
            <p className="text-gray-500 text-lg max-w-xl mx-auto">Built specifically for how Indian NGOs and community groups actually operate.</p>
          </div>
      ...
      <section className="py-24 px-6 bg-[#f5f5f7]">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-[#1d1d1f] mb-12 text-center">Organisation FAQs</h2>
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-4xl font-bold text-[#1d1d1f] mb-4">Ready to grow your volunteer program?</h2>
          <p className="text-gray-500 mb-8 text-lg">Join verified organisations across India using Kindly to make their missions more effective.</p>
          <a
            href="/org-signup"
