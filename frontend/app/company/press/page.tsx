  ...
  return (
    <div className="bg-background min-h-screen pt-32 pb-20 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Hero Section */}
        <div className="mb-20">
          <h1 className="text-5xl font-bold text-foreground mb-6">Press & Media.</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          <div>
            <h2 className="text-2xl font-bold text-foreground mb-4">About KINDLY</h2>
          ...
          <div className="grid grid-cols-2 gap-6 bg-muted p-8 rounded-3xl">
            <div>
              <h4 className="text-4xl font-bold text-foreground mb-1">100%</h4>
              <p className="text-sm text-muted-foreground font-medium">Verified NGOs</p>
            </div>
            <div>
              <h4 className="text-4xl font-bold text-foreground mb-1">2025</h4>
              <p className="text-sm text-muted-foreground font-medium">Year Founded</p>
            </div>
            <div>
              <h4 className="text-xl font-bold text-foreground mb-1 pt-4">Nashik, IN</h4>
              <p className="text-sm text-muted-foreground font-medium">Headquarters</p>
            </div>
            <div>
              <h4 className="text-xl font-bold text-foreground mb-1 pt-4">Tech</h4>
              <p className="text-sm text-muted-foreground font-medium">Sector</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Brand Assets Card */}
          <div className="border border-border rounded-3xl p-10 hover:border-black transition-all group cursor-pointer flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 bg-muted rounded-full flex items-center justify-center mb-6">
                <Download className="w-5 h-5 text-foreground" />
              </div>
              <h3 className="text-2xl font-bold text-foreground mb-3">Brand Assets</h3>
          ...
          {/* Press Contact Card */}
          <div className="bg-[#1d1d1f] dark:bg-[#0a0a0c] rounded-3xl p-10 flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 bg-card/10 rounded-full flex items-center justify-center mb-6">
