...
const faqs: FAQItem[] = [
  ...
  { category: "getting-started", q: "I signed up but I can't log in. What should I do?", a: "First, check that you are using the correct email address you signed up with. If you have forgotten your password, use the 'Forgot Password' link on the login page — a reset link will be sent to your email. If you still cannot log in, contact us at manasdhivare@gmail.com and we will resolve it within 24 hours." },
  ...
  { category: "account", q: "How do I change my password?", a: "Go to Settings and select 'Change Password'. Enter your current password and then your new one. If you have forgotten your current password, log out and use 'Forgot Password' on the login page to reset via email." },
  ...
  { category: "account", q: "Can I delete my account?", a: "Yes. Contact us at manasdhivare@gmail.com from your registered email and request account deletion. We will delete your profile and all personal data within 7 business days, in accordance with applicable data protection laws. Certificates already downloaded will remain valid." },

  // Technical
  { category: "technical", q: "The app is not loading. What should I do?", a: "First, check your internet connection. Try refreshing the page or clearing your browser cache. If the issue persists on mobile, try opening Kindly in a different browser. If you are experiencing issues on a specific page, note the URL and contact us at manasdhivare@gmail.com with a description of what is happening." },
