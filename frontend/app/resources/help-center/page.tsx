...
const faqs: FAQItem[] = [
  ...
  { category: "getting-started", q: "I signed up but I can't log in. What should I do?", a: "First, check that you are using the correct email address you signed up with. If you have forgotten your password, use the 'Forgot Password' link on the login page — a reset link will be sent to your email. If you still cannot log in, contact us at team@kindly.co.in and we will resolve it within 24 hours." },
