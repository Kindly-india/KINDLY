...
const faqs: FAQItem[] = [
  ...
  { category: "technical", q: "I uploaded photos to an event gallery but they are not showing.", a: "Gallery uploads may take a few seconds to process. Refresh the event page after 30 seconds. If photos are still not showing after a minute, the upload may have failed — try uploading again with a stable internet connection. Keep individual photo file sizes under 25MB." }
]
